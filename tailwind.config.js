  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "blockchain-blue": "var(--color-blockchain-blue)", // blue-600
        "natural-green": "var(--color-natural-green)", // emerald-600
        "alert-red": "var(--color-alert-red)", // red-600
        "verification-green": "var(--color-verification-green)", // emerald-500
        "pending-amber": "var(--color-pending-amber)", // amber-500
      },
      borderRadius: {
        lg: "var(--radius)",
